...
### 3) Implement（TDD）: 要件および仕様を満たし、テストで担保された実装が追加される
...
### 7) Post-PR Check: PRがマージ可能な状態になる
...
### 8) Session Retrospective: セッションのレポートが作成され、配置される
