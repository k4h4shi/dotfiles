...
# Same setting as https://github.com/mathiasbynens/dotfiles/.osx
# 
...
tell application "Terminal"
	...
	do shell script "open '$HOME/etc/init/osx/terminal" & themeName & ".terminal'"
